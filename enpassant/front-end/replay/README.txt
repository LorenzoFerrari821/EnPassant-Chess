...
1) requirements:
npm install --save babel-loader @babel/core @babel/preset-env @babel/preset-react react react-dom webpack webpack-cli chessboardjsx chess.js style-loader css-loader react-countdown react-bootstrap bootstrap 
